...
class ValidatorInternalState {
     ...
     * @param {string[]} [errorContextPaths] add one or more additional context paths to the errorContextValuePaths generated by this validator and sub validators, if `undefined` the errorContextValuePaths from this instance will be used
